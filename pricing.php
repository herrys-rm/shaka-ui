        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                <div class="features-item p-4 pt-0">
                    ...
                    <h2 class="mb-4">Paket Basic</h2>
                    <h2><sup>Rp</sup>35.000/m²<span></span></h2>
                    <p class="mb-4">bdfjsfb
                        <li><span>Perencanaan Denah</span></li>
                        </h8>
                        <h8>
                            <li> <span>Visual Desain</span></li>
                        </h8>
                        <h8>
                            <li><span> eksterior + Rendering </span></li>
                        </h8>
                        <h8>
                            <li><span>Gambar Kerja (Denah, Tampak Potongan dan Detail)</span></li>
                        </h8>
                        <h8>
                            <li><span>Print Out Gambar Detail dan Desain</span></li>
                        </h8>
                        <h8>
                            <li><span>Fail PDF. </span></li>
                        </h8>
