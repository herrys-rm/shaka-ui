...
<nav class="navbar navbar-expand-lg bg-navbar navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            <a href="index.php" class="nav-item nav-link <?php if($current_page == 'index.php') { echo 'active'; } ?>">Beranda</a>
            <a href="tentang-selengkapnya.php" class="nav-item nav-link <?php if($current_page == 'tentang-selengkapnya.php') { echo 'active'; } ?>">Tentang Kami</a>
            <a href="portofolio.php" class="nav-item nav-link <?php if($current_page == 'portofolio.php') { echo 'active'; } ?>">Portofolio</a>
            <a href="contact.php" class="nav-item nav-link <?php if($current_page == 'contact.php') { echo 'active'; } ?>">Kontak</a>
        </div>
