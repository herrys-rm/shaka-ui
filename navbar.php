<nav class="navbar navbar-expand-lg bg-navbar navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
        <h1 class="text-shaka m-0"><img class="me-3" src="img/icons/saka.png" alt="Icon">Saka Design</h1>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="" class="btn btn-light py-2 px-4 d-none d-lg-block">Hubungi Kami</a>
    </div>
</nav>